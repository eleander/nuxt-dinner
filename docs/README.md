...
#### Runtime Config - [Ref](https://nuxt.com/docs/guide/going-further/runtime-config)
To expose config and environment variables to the rest of your app, you will need to define runtime configuration in your **nuxt.config** using the runtimeConfig option. 
...
```env
NUXT_PUBLIC_API_BASE=yourPublicApiBase
NUXT_API_SECRET=yourSuperSecretKey
```
